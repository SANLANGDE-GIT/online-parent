...
//        gc.setFileOverride(true); //重新生成时文件是否覆盖
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/" + prefix + "guli_" + moduleName + "?serverTimezone=UTC");
        dsc.setDriverName("com.mysql.cj.jdbc.Driver");
        dsc.setUsername("croot");
    ...
    @Test
    public void converterEmoji(){
        String str = "如意仙子花坊（霞飞）";
        String html = EmojiConverter.getInstance().toHtml(str);
